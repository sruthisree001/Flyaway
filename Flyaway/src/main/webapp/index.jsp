...
<body >
				...
				<h3 style="text-align:center;color:deeppink;"> 
							Jobs fill your pockets, adventures fill your soul.<br><br>
						Remember that happiness is a way of travel, not a destination. </h3>
